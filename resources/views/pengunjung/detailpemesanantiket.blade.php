...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container d-flex h-100 align-items-center">
            <div class="mx-auto text-center">
                <h1 class="mx-auto my-0 text-uppercase"><a href="#tiket">Detail Pemesanan Tiket</a></h1>
    ...
    <section class="projects-section bg-white" id="tiket">
        <h5 style="margin-left: 60px;color: red;">Pemberitahuan: Untuk pesanan tiket yang belum dibayar silahkan dilihat di Menu Tiket pada Sub Menu Pembayaran Tiket</h5>
        <table class="table col-lg-11" style="margin-left: 60px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{route('lihatdatapemesanantiket.show',$item->id)}}">Lihat Data</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
